...
const ProductList = () => {
    ...
    const RenderQuantiteGrid = props => {
      ...
      return (
        <View style={[styles.safeContainerStyle,{width: windowWidth * 0.25}]} key={productId}>
          <DropDownPicker
            style={{backgroundColor: "#F5F5F5" ,borderColor: "transparent", padding: 0, position: "relative", zIndex: 1000,}}
            dropDownContainerStyle={{backgroundColor: "#F5F5F5" ,borderColor: 'transparent',fontSize: 54}}
              ...
              {products.map((product) => (
                  ...
                  <View style={{flexDirection: "row", alignItems: "center",gap: 10, paddingVertical: 12, paddingLeft: 22}}>
                      ...
                      <View style={{flexDirection: "column", justifyContent: "center", alignItems: "flex-start"}}>
                          ...
                          <View style={{marginTop: 10, width:windowWidth * 0.45, position: "relative", zIndex: -10}}>
          ...
          <>
            <View style={{ backgroundColor: "#fff", margin: 4.5, borderRadius: 10, }} key={product.id}>
                <View style={{flexDirection: "row", alignItems: "center",justifyContent: "space-between" ,gap: 10, paddingTop: 16, paddingLeft: 6, paddingRight: 6}}>
                  ...
                  <View style={{flexDirection: "row",gap: 5 ,alignItems: "center", paddingBottom: 8, paddingLeft: 6}}>
                    <View>
                        <ScrollView
                            pagingEnabled
                            horizontal
                            ...
                            {product.productImages.map((image, index) => (
                                <PhotoZoomer key={index} image={image} windowWidth={wp(21)} windowHeight={hp(18)} />
                            ))}
                        </ScrollView>
