            ...
            return (
              <View style={{alignItems: 'center', justifyContent: 'center', position: "relative"}}>
                ...
                <View style={{ position: "absolute", top: -5, right: -5, backgroundColor: '#F4951A', width: 20, height: 20, justifyContent: "center", alignItems: "center", borderRadius: 50}}>
                  <Text style={{fontSize: 12, fontFamily: "Poppins-Medium", color: "#fff"}}>{useBag().bagCount}</Text>
                </View>
              </View>
            );
          },
      ...
      >
        {
          () => (
            <Profile.Navigator screenOptions={{ headerShown: false}}>
              ...
              <Profile.Screen name='EditAdresseScreen' component={EditAdressScreen}/>
