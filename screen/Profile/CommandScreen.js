...
const CommandScreen = (props) => {
    ...
    console.log("CommandesEnCours :", CommandProducts);
              ...
              (
                <View style={{ width: windowWidth * 1.5, alignSelf: "center"}}>
                  ...
                  <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                      <View style={{width: 18, height: 18, borderRadius: 50, backgroundColor: "#fff", borderWidth: 6, borderColor: "#2BA6E9"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#F2F2F2"}}></View>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#F2F2F2", borderWidth: 4, borderColor: "#F2F2F2"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#F2F2F2"}}></View>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#F2F2F2", borderWidth: 4, borderColor: "#F2F2F2"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#F2F2F2"}}></View>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#F2F2F2", borderWidth: 4, borderColor: "#F2F2F2"}}></View>
            ...
            }
            {
              ...
              (
                <View style={{ width: windowWidth * 1.5, alignSelf: "center"}}>
                  ...
                  /> */}
                  <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#2BA6E9", borderWidth: 4, borderColor: "#2BA6E9"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#2BA6E9"}}></View>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#2BA6E9", borderWidth: 4, borderColor: "#2BA6E9"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#2BA6E9"}}></View>
                      <View style={{width: 12, height: 12, borderRadius: 50, backgroundColor: "#2BA6E9", borderWidth: 4, borderColor: "#2BA6E9"}}></View>
                      <View style={{ width: 70, height: 2,justifyContent: "center",alignItems: "center" ,borderWidth: 1, borderColor: "#2BA6E9"}}></View>
