...
import { getParametrages, getPlatformLanguage, getSelectedCountry, getSelectedService } from '../../modules/GestionStorage'
  ...
  return (
    <View style={{marginBottom: 85}}>
        ...
        {/* {
         ...
         <Categorie Categories={Categories} styles={styles} Language={Language} SelectedCategorieId={SelectedCategorieId} setSelectedCategorieId={setSelectedCategorieId}/>
        {
          <>
              ...
              (
                <>
                  <View style={{marginTop: 10, paddingHorizontal: 5}}>
                    <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center",borderTopLeftRadius: 28, borderTopRightRadius: 28 ,backgroundColor: "#fff", paddingVertical: 15, paddingLeft: 15, paddingRight: 23}}>
                      
                      <View style={{flexDirection:"row", alignItems: "center", gap: 10}}>
                      <TouchableOpacity style={{flexDirection:"row", alignItems: "center", gap: 8}} activeOpacity={0.5}>
                        <Text style={{fontFamily: "Poppins-Medium", fontSize: wp(3.1), color: "#376AED" }}>
                          {t('Filtrer')}
                        </Text>
                        <MaterialIcons name="arrow-drop-down" color="#376AED" size={wp(5.5)}/>
                      </TouchableOpacity>
                        <TouchableOpacity style={{flexDirection:"row", alignItems: "center", gap: 8}} activeOpacity={0.5}>
                          <Text style={{fontFamily: "Poppins-Medium", fontSize: wp(3.1), color: "#376AED" }}>
                            {t('Trier')}
                      ...
                      <View style={{flexDirection:"row", alignItems: "center", gap: 10}}>
                      {
                                  ...
                                  <TouchableOpacity onPress={() => setActiveFilter(1)}>
                                      <Ionicons name="grid-outline" color="#00000033" size={wp(5.2)}/>
                                  </TouchableOpacity> 
                                  :
                                  <TouchableOpacity onPress={() => setActiveFilter(0)}>
                                      <Ionicons name="grid-outline" color="#376AED" size={wp(5.2)}/>
                                  </TouchableOpacity> 
                                }
                                {
                                  activeFilter === 1 
                                  ?
                                  <TouchableOpacity onPress={() => setActiveFilter(0)}>
                                      <Octicons name="list-unordered" color="#00000033" size={wp(5.2)}/>
                                  </TouchableOpacity> 
                                  :
                                  <TouchableOpacity onPress={() => setActiveFilter(1)}>
                                      <Octicons name="list-unordered" color="#376AED" size={wp(5.2)}/>
                                  </TouchableOpacity> 
                                }
                      </View>
