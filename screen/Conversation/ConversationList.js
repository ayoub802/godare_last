import { View, Text, TouchableOpacity,Platform,TouchableWithoutFeedback ,Keyboard, Dimensions,KeyboardAvoidingView, ActivityIndicator, ScrollView, TextInput, Image } from 'react-native'
                                    ...
                                    <ScrollView style={{height: "100%",position: "relative", zIndex: -1000, marginBottom: 50}} showsVerticalScrollIndicator={false}>
                                        {conversation.messages.map(message => (
                                            <View key={message.id} style={{ margin: 10,position: "relative", zIndex: -10 }}>
                                            {
                                              ...
                                              <View style={{flexDirection: "row", alignItems: "flex-start",gap: 5 ,paddingHorizontal: 15}}>
                                                  <View style={{flexDirection: "column",marginTop: 10}}>
                                                    <Image source={SmallEarth}/>
                                                    <Text style={{color: "#000",textAlign: "center" ,fontFamily: "Roboto-Bold", fontSize: 14}}>GS</Text>
                                                  </View>
                                                  <View style={{alignSelf: "flex-end", paddingRight: 25, marginVertical: 10,backgroundColor: "#2BA6E9", paddingHorizontal: 15, paddingVertical: 12, borderRadius: 12}}>
                                                      <Text style={{color: "#fff", textAlign: "left", fontSize: 16,fontFamily: "Poppins-Medium"}}> De</Text>
                                        ...
                                        <View style={{flex: 1, justifyContent: "flex-start",alignSelf: "center",backgroundColor: "#fff",marginBottom: windowWidth * 0.05}}>
                                          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                                                ...
                                                <View style={{flexDirection: "row",alignItems: "center" ,gap: 10, width: windowWidth * .95, alignSelf: "center"}}>
                                                    <TouchableOpacity style={{width: 60, height: 60, backgroundColor: "#2BA6E9", alignItems: "center", justifyContent: "center", borderRadius: 50}}>
                                                       <Icon name="plus" size={25} color="#fff"/>
                                                    </TouchableOpacity>
                                                    <View style={{width: windowWidth * 0.78,flexDirection: "row",alignItems: "center",borderWidth: 1,borderRadius: 8,borderColor: "#AAB0B7", paddingHorizontal: 10}}>
                                                          <TextInput 
                                                            value={newMessage}
