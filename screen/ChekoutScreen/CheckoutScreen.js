import { View, Text, Image, TextInput, TouchableOpacity,ScrollView, StyleSheet, ActivityIndicator, FlatList } from 'react-native'
...
const CheckoutScreen = (props) => {
  ...
  const RenderTotal = ({data}) => {
    ...
    let montantApayer =  parseFloat(apreRemise) + prixTotalLivraison + sommeFraisDouane;
  ...
  return (
    <View style={{ flex: 1,}}>
        ...
        <View style={{paddingBottom: 80 , flex: 1}}>
          ...
          {('fret-par-avion' == Service.code || 'fret-par-bateau' == Service.code) ?
            (
              <>
                    ...
                    <View style={styles.firstContainerInformation}>
                      ...
                      <View style={styles.secondRow}>
                        <View>
                          ...
                          <Text style={styles.WeightCalSubText}>
                            {t('Mode')} : {DepotData.depotMode}
                          </Text>

                          {DepotData.depotDepartement && (
                              <Text style={styles.WeightCalSubText}>
                              {t('Département')} : {DepotData.depotDepartement}
                              </Text>
                            )
                          }
                          ...
                          <Text style={styles.WeightCalSubText}>
                            {t('Adresse')} : {DepotData.depotMagasinAdresse ? DepotData.depotMagasinAdresse : DepotData.depotEnlevementAdresse}
                          </Text>
                          ...
                          {DepotData.depotCreneau && (
                              <>
                                <Text style={styles.WeightCalSubText}>
                                {t('Créneau Date')} : {DepotData.depotCreneau.date}
                                </Text>
                                <Text style={styles.WeightCalSubText}>
                                {t('Créneau heure')} : {DepotData.depotCreneau.horaireDebut + ' - '  + DepotData.depotCreneau.horaireFin}
                                </Text>
                              </>
                            )
                          }
