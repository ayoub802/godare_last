...
const CommandeDetail = ({ navigation, route }) => {
    ...
    const fetchCommande = async () => 
    {
        ...
        try 
        {
          ...
          console.log(email);
          const response = await axiosInstance.get('https://godaregroup.com/api/commandes/122/adminyounes@gmail.com');
        ...
        <View style={{flex: 1}}>
              ...
              <ScrollView style={{flex: 1}}>
                ...
                <View style={{marginTop: 24, paddingHorizontal: 16}}>
                     <Text style={{fontSize: 14, color: "#C3BCBC", fontFamily: "Poppins-Regular", letterSpacing: 1}}>N° de commande</Text>
                     <View>
                    ...
                    <View style={{backgroundColor: "#fff",padding: 14,borderRadius: 10}}>
                      <View style={{flexDirection: "row", alignItems: "flex-start", gap: 20}}>
                           ...
                           </View>
                           {
                            ...
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("Payée")}</Text>
                           ...
                           {
                            Commande.service == "Fret par ventes privée" 
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("Payée")}</Text>
                                <Text style={{color: "#C3BCBC", fontFamily: "Poppins-Regular", fontSize: 12, letterSpacing: 1}}>{ Commande.createdAt }</Text>
                           ...
                           {
                            Commande.service == "Fret demande d’achat" 
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("Payée")}</Text>
                                <Text style={{color: "#C3BCBC", fontFamily: "Poppins-Regular", fontSize: 12, letterSpacing: 1}}>{ Commande.createdAt }</Text>
                      ...
                      <View style={{flexDirection: "row", alignItems: "flex-start", gap: 20}}>
                           ...
                           </View>
                           {
                            ...
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("Chez le transporteur")}</Text>
                                <Text style={{color: "#C3BCBC", fontFamily: "Poppins-Regular", fontSize: 12, letterSpacing: 1}}>{ Commande.createdAt }</Text>
                            </View>
                            :
                            <></>
                           ...
                           }
                           {
                            ...
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("En cours de préparation")}</Text>
                                <Text style={{color: "#C3BCBC", fontFamily: "Poppins-Regular", fontSize: 12, letterSpacing: 1}}>{ Commande.createdAt }</Text>
                            </View>
                            :
                            <></>
                      ...
                      <View style={{flexDirection: "row", alignItems: "flex-start", gap: 20}}>
                           ...
                           </View>
                           {
                            ...
                            ?
                            <View>
                                <Text style={{color: "#292625", fontFamily: "Poppins-Medium", fontSize: 14, letterSpacing: 1}}>{t("En transit")}</Text>
                                <Text style={{color: "#C3BCBC", fontFamily: "Poppins-Regular", fontSize: 12, letterSpacing: 1}}>{ Commande.createdAt }</Text>
                            </View>
                            :
                            <></>
                    ...
                    <View style={{flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                       ...
                       <View>
                          ...
                          <Text style={{color: "#C3BCBC", fontSize: 13, fontFamily: "Poppins-Regular", letterSpacing: 1}}>
                           N° de commande { Commande.uuid ? Commande.uuid : 222222 }
                          </Text>
                       </View>
                       <View>
                         <TouchableOpacity>
