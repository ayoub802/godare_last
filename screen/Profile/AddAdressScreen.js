        ...
        <View style={{flex: 1,marginBottom: 150}}>
              <View style={{marginTop: 30, marginBottom: 12}}>
                ...
                <View style={{marginTop: 50, flex: 1, justifyContent: "center", alignItems: "center",}}>
                    ...
                    <TouchableOpacity style={{ paddingVertical: 8 ,paddingHorizontal: 22, width: windowWidth * 0.36,flexDirection: "row", alignItems: "center",justifyContent: "center", backgroundColor: "#4E8FDA", borderRadius: 25}} onPress={AddNewAddress}>
                      <Text style={{fontFamily:"Poppins-Medium", fontSize: 12, color:"#fff"}}>{t('Ajouter Address')}</Text>
                    </TouchableOpacity>
                </View>
                <View style={{marginTop: 10, flex: 1, justifyContent: "center", alignItems: "center",}}>
                    {/* <Button title={t("Ajouter l'adresse")} onPress={AddNewAddress}/> */}
                    <TouchableOpacity style={{ paddingVertical: 8 ,paddingHorizontal: 22, width: windowWidth * 0.36,flexDirection: "row", alignItems: "center",justifyContent: "center", backgroundColor: "#4E8FDA", borderRadius: 25}} onPress={returnPage}>
                      <Text style={{fontFamily:"Poppins-Medium", fontSize: 12, color:"#fff"}}>{t('Retour')}</Text>
                    </TouchableOpacity>
                </View>
